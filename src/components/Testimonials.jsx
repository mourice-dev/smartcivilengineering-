      ...
      <div className="relative z-10 text-center space-y-6">
        ...
        <AnimatePresence mode="wait">
          <motion.p
            ...
            className="text-slate-700 font-serif italic text-base sm:text-lg leading-relaxed max-w-2xl mx-auto font-medium"
          >
        ...
        <div className="space-y-1">
          ...
          <span className="text-[10px] sm:text-xs text-slate-450 font-bold uppercase tracking-wider">
        ...
        <div className="flex justify-center space-x-3 pt-4">
          <button
            onClick={prevReview}
            className="h-10 w-10 flex items-center justify-center bg-slate-50 border border-slate-200/50 hover:bg-accent hover:text-white text-slate-650 rounded-xl transition-all duration-200 focus:outline-none"
