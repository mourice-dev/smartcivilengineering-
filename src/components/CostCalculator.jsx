...
const CostCalculator = () => {
  ...
  return (
    <div className="bg-white border border-slate-200/50 rounded-3xl p-6 md:p-10 shadow-2xl max-w-4xl mx-auto font-sans text-slate-650">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        
        {/* Left Side: Inputs */}
        <div className="lg:col-span-6 space-y-6">
          <div className="space-y-2">
            <h3 className="text-xl font-display font-black text-navy uppercase tracking-wide flex items-center space-x-2">
          ...
          <div className="space-y-4 text-xs font-semibold">
            {/* Project Type */}
            <div className="space-y-2">
              <label className="text-slate-500 uppercase tracking-wider text-[10px]">Construction Type</label>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                <label className="text-slate-500 uppercase tracking-wider text-[10px]">Estimated Area</label>
            ...
            {/* Terrain Slope */}
            <div className="space-y-2">
              <label className="text-slate-500 uppercase tracking-wider text-[10px]">Terrain Slope Profile</label>
        ...
        {/* Right Side: Estimated Outputs (Remains dark blue for corporate contrast) */}
        <div className="lg:col-span-6 bg-navy text-white p-6 md:p-8 rounded-2xl relative overflow-hidden shadow-2xl border border-white/5">
          ...
          <h4 className="text-slate-350 font-bold tracking-wider uppercase text-[9px] mb-4">Estimated Fees Breakdown</h4>
          ...
          <div className="space-y-4 text-xs font-semibold">
            ...
            {/* Total Fee Proposal */}
            <div className="flex justify-between items-center pt-4 text-sm sm:text-base border-t border-accent/30">
              <span className="text-accent uppercase tracking-wider font-black">Estimated Consultancy Fee:</span>
              <span className="text-white font-serif font-black text-xl sm:text-2xl">${estimates.total.toLocaleString()}</span>
            </div>
          </div>

          <div className="mt-6 flex items-start space-x-2 text-[10px] text-slate-400 leading-normal font-medium">
