...
const Footer = () => {
  ...
  return (
    <footer className="bg-navy text-slate-400 border-t border-white/5 pt-10 pb-6 font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="flex flex-col">
            <div className="flex items-center">
              <img src={logo} alt="Smart Civil Engineering Works Ltd Logo" className="h-14 w-auto object-contain" />
            </div>
            ...
            <div className="text-[9px] text-slate-500 font-bold tracking-wider uppercase mt-2">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-[10px] font-semibold tracking-wide">
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-[10px] font-semibold leading-relaxed">
              ...
              <li className="flex items-start space-x-2.5">
                ...
                <div className="flex flex-col text-[9px] text-slate-400 space-y-0.5">
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between text-[10px] text-slate-500 space-y-4 sm:space-y-0 font-medium">
          <div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="flex items-center justify-center h-7 w-7 bg-white/5 text-slate-400 hover:text-white rounded-lg border border-white/5 hover:border-white/10 hover:bg-white/10 transition-all duration-200"
