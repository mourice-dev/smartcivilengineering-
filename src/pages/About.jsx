    ...
    <div className="pt-16 bg-warm-bg text-slate-700">
      ...
      <section className="bg-navy text-white py-12 md:py-16 relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
          ...
          <p className="text-slate-350 font-sans text-[10px] max-w-2xl mx-auto leading-relaxed font-medium">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 bg-warm-bg text-center">
        <div className="space-y-6">
          <h2 className="text-sm font-black text-navy uppercase leading-snug">
            About Our Company
          </h2>
          <div className="space-y-4 font-sans text-[10px] leading-relaxed text-slate-600 font-medium text-left max-w-2xl mx-auto">
            <p>
          ...
          <div className="border-y border-slate-200/60 py-4.5 italic text-accent font-sans bg-accent/5 rounded-2xl text-[10px] font-bold leading-relaxed text-center max-w-2xl mx-auto px-6 mt-4">
      ...
      <section className="bg-slate-100 py-12 md:py-16 border-y border-slate-200/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Vision */}
            <div className="bg-white border border-slate-200/50 p-8 md:p-10 rounded-3xl shadow-xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 h-1.5 w-full bg-accent" />
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-accent/10 text-accent mb-6">
                <Compass className="h-4.5 w-4.5" />
              </div>
              <h3 className="text-sm font-black text-navy uppercase mb-4 group-hover:text-accent transition-colors">
                Our Vision
              </h3>
              <p className="text-slate-650 font-sans text-[11px] leading-relaxed font-medium">
            ...
            <div className="bg-white border border-slate-200/50 p-8 md:p-10 rounded-3xl shadow-xl relative overflow-hidden group">
              ...
              <p className="text-slate-655 font-sans text-[11px] leading-relaxed font-medium">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 bg-warm-bg">
        <div className="text-center max-w-3xl mx-auto mb-10 space-y-4">
          ...
          <p className="text-slate-600 font-sans text-[10px] font-medium">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {coreValues.map((val, idx) => {
            const Icon = val.icon;
            return (
              <div key={idx} className="bg-white border border-slate-200/50 p-6 rounded-3xl space-y-4 hover:border-accent/20 transition-all shadow-lg">
                ...
                <h3 className="text-navy font-sans font-bold text-xs uppercase tracking-wide">
                  {val.title}
                </h3>
      ...
      <section className="bg-slate-100 text-slate-700 py-12 md:py-16 border-t border-slate-200/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 font-sans">
          <div className="text-center max-w-3xl mx-auto mb-10 space-y-4">
            <span className="text-accent text-[9px] font-black tracking-widest uppercase bg-accent/15 px-3 py-1 rounded-lg inline-block">
              Leadership
            </span>
            <h2 className="text-lg md:text-xl font-serif font-black uppercase text-navy">
              Meet Our Board
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl mx-auto">
            {team.map((member, idx) => (
              <div key={idx} className="bg-white border border-slate-200/50 rounded-3xl p-8 flex flex-col items-center text-center space-y-6 hover:border-accent/20 transition-all duration-300 shadow-xl">
                <div className="h-26 w-26 rounded-2xl overflow-hidden bg-slate-200 shadow-lg shadow-slate-300/20">
                  <img 
                    src={member.avatar} 
                    alt={member.name} 
                ...
                <div className="space-y-1">
                  <h3 className="text-sm font-black text-navy uppercase">{member.name}</h3>
                  <span className="text-[9px] text-accent font-black uppercase tracking-widest">{member.role}</span>
                </div>
                <p className="text-slate-655 text-[10px] leading-relaxed max-w-md font-medium">
                  {member.bio}
                </p>
              </div>
            ))}
