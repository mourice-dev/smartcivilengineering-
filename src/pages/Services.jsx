    ...
    <div className="pt-16 font-sans bg-warm-bg text-slate-700">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-6 space-y-2">
          <h2 className="text-sm font-black text-navy uppercase mb-2">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-1/3 flex flex-col space-y-2 border-r border-slate-200/50 pr-0 lg:pr-6">
            {serviceCategories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center space-x-3 p-3 rounded-xl text-left transition-all duration-200 ${
                    isActive 
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="font-black text-[10px] tracking-wide leading-tight uppercase font-sans">{category.title}</span>
                  </div>
                </button>
              );
            })}
          ...
          <div className="w-full lg:w-2/3">
            <AnimatePresence mode="wait">
              ...
              >
                {/* Division Intro */}
                <div className="space-y-2 bg-navy text-white p-4 rounded-2xl relative overflow-hidden shadow-md border border-white/5">
                  ...
                  <p className="relative z-10 text-slate-350 text-[10px] leading-relaxed font-medium">
                    {activeCategory.desc}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {activeCategory.items.map((item, index) => (
                    <div 
                      key={index}
                      className="bg-white border border-slate-200/50 p-4 rounded-2xl shadow-md hover:border-accent/20 transition-all flex items-start space-x-3 text-slate-700"
                    >
                      <CheckCircle className="h-4 w-4 text-accent shrink-0 mt-0.5" />
                      <div className="space-y-0.5">
                        <h4 className="font-bold text-navy text-[11px] uppercase leading-snug tracking-wide font-sans">
                          {item.name}
                        </h4>
                        <p className="text-slate-650 text-[10px] leading-relaxed font-medium">
                          {item.details}
                        </p>
                      </div>
                    </div>
      ...
      <section className="bg-slate-100 py-6 md:py-8 border-t border-slate-200/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-6 space-y-2">
            <span className="text-accent text-[9px] font-black tracking-widest uppercase bg-accent/10 px-3 py-1 rounded-lg font-sans">
              Frequently Asked Questions
            </span>
            <h2 className="text-lg md:text-xl font-serif font-black text-navy uppercase">
              Permits, Audits & Operations
            </h2>
            <p className="text-slate-600 font-sans text-[10px] max-w-xl mx-auto font-medium leading-relaxed">
      ...
      {/* FAQ/Info Banner */}
      <section className="bg-navy text-white py-8 md:py-10 border-t border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4 relative z-10 font-sans">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-accent/10 text-accent border border-accent/20 mx-auto shadow-md">
            <HelpCircle className="h-4.5 w-4.5" />
          </div>
          <h3 className="text-lg md:text-xl font-serif font-black uppercase tracking-tight text-white">Need Custom Technical Specifications?</h3>
          <p className="text-slate-350 text-[10px] max-w-xl mx-auto leading-relaxed font-medium">
          ...
          <div className="pt-2">
            <a
              ...
              className="inline-flex items-center space-x-2 px-5 py-2.5 bg-accent hover:bg-white text-white hover:text-navy text-[10px] font-black tracking-widest uppercase rounded-lg transition-all shadow-md hover:scale-[1.01]"
            >
